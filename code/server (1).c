...
void checkvote(int client_sock)
{
	//int client_sock;
	...
	FILE *fp;
	char buff[255];
	fp = fopen("/home/anirudh/cn/proman/Voters_List.txt", "r");
	int voter_found = 0;
	...
	memset(client_message,'\0',sizeof(client_message));
		...
		fp = fopen("/home/anirudh/cn/proman/Votes.txt", "r");
		...
		if (vote_casted == 0)
		{
			...
			fp = fopen("/home/anirudh/cn/proman/Candidates_List.txt", "r");
			...
			fp = fopen("/home/anirudh/cn/proman/Votes.txt", "a");
			fputs(vote, fp);
			fclose(fp);
	...
	else
	{
		...
		if(newline != NULL)
			*newline = '\0';
		// Write Voters_List.txt 
		FILE *fp;
		char buff[255];
		fp = fopen("/home/anirudh/cn/proman/Voters_List.txt", "a");
